...
output_file = 'expanding_universe_half_circle.mp4'
...
# Initialize trail points for angles (-90 to 90 degrees)
angles = np.deg2rad(np.arange(-90, 91, 10))  # Angles for left half-circle
...
for frame_idx in range(total_frames):
    ...
    # Display the frame
    cv2.imshow('Expanding Universe Half-Circle Trails', frame)
