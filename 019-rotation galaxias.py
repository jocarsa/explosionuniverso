...
rgb_gray = (150, 150, 150)  # RGB values for general gray trails
galaxy_gray = (100, 100, 100)  # RGB values for gray galaxies in snapshots
particle_trail_color = (50, 50, 50)  # RGB values for gray particle trails
    ...
    for snapshot in arc_snapshots:
        ...
        for particle_trail in snapshot['particle_trails']:
            for particle_pos in particle_trail:
                cv2.circle(frame, particle_pos, particle_size, particle_trail_color, -1, cv2.LINE_AA)
