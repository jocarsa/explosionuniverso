    ...
    for snapshot in arc_snapshots:
        ...
        for particle_trail in snapshot['particle_trails']:
            for particle_pos in particle_trail:
                cv2.circle(particle_overlay, particle_pos, particle_size, particle_trail_color, -1, cv2.LINE_AA)

    # Blend the particle_overlay with the main frame using alpha=0.2
